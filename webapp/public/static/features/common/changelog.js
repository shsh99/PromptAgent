...
const CHANGELOG_ITEMS = [
  {
    ...
    version: 'v4.13',
    items: [
      { tag: 'improve', text: '홈 히어로의 버튼 정렬과 문단 폭을 조정해 첫 화면 가독성을 개선했습니다.' },
      { tag: 'improve', text: '모드 선택 패널 하단에 빠른 흐름 안내를 넣어 빈 공간을 자연스럽게 채웠습니다.' },
      { tag: 'improve', text: 'AI 스타일 패널의 높이와 라이트/다크 토큰을 맞춰 좌우 균형과 가시성을 정리했습니다.' },
      { tag: 'fix', text: '템플릿 시작용 보조 카드 블록을 화면에서 제외해 불필요한 중복을 제거했습니다.' },
    ],
  },
  {
    date: '2026-04-02',
