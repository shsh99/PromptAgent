...
- 배포 URL: https://promptbuilder-df6.pages.dev/
...
`main` 브랜치에 push 하면 GitHub Actions가 Cloudflare Pages로 자동 배포합니다.

GitHub 저장소 `Settings > Secrets and variables > Actions`에 아래 2개를 추가해야 합니다.
