...
## 사이트
[프롬프트 빌더](https://promptbuilder-df6.pages.dev/)
...
- 홈 히어로의 버튼 정렬과 문단 폭을 손봐서 줄바꿈이 덜 끊기도록 다듬었습니다.
- 모드 선택 패널 안에 빠른 흐름 안내를 넣어 첫 화면의 빈 공간을 자연스럽게 채웠습니다.
- AI 스타일 패널의 높이와 라이트/다크 토큰을 맞춰 좌우 균형과 가시성을 정리했습니다.
...
- 세로 스크롤로 이전 버전을 찾지 않아도 되도록 카드 내부 전환 UX를 추가했습니다.
## 최근 작업 기록

- 업데이트 로그를 최신 상태로 정리하고, 관리자 대시보드와 히스토리 UX 개선 내용을 문서에 함께 남겼습니다.
